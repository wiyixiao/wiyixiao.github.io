...
Stepper myStepperY(stepsPerRevolution, 3,4);            
Stepper myStepperX(stepsPerRevolution, 8,9);  
Stepper myStepperZ(stepsPerRevolution, 10,11);
...
float StepsPerMillimeterX = 10;
float StepsPerMillimeterY = 10;
...
void setup() {
  ...
  myStepperX.setSpeed(1500);
  myStepperY.setSpeed(1500);  
...
void drawLine(float x1, float y1) {
  ...
  x1 = (int)(x1*10*StepsPerMillimeterX);
  y1 = (int)(y1*10*StepsPerMillimeterY);
  float x0 = Xpos;
  float y0 = Ypos;
